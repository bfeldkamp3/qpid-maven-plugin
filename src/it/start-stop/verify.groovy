...
def deleteMeFile = new File(basedir, 'target/qpid/DELETE_ME.txt')
assertFalse "Should have cleaned qpid work directory before running tests", deleteMeFile.exists()
